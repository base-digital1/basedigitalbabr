...
export default function Sobre() {
  ...
  return (
    <section id="sobre" className="py-20 md:py-32 px-4 md:px-8 bg-[#111111] relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative">
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            <div className="bg-[#1a1a1a]/95 backdrop-blur-md p-8 md:p-16 rounded-[20px] shadow-[0_30px_60px_rgba(0,0,0,0.8)] border border-white/5">
              <h2 className="text-4xl md:text-5xl lg:text-7xl text-primary mb-6 md:mb-8 uppercase tracking-widest font-heading">Sobre Nós</h2>
              <div className="space-y-4 md:space-y-6 text-gray-300 text-base md:text-lg leading-relaxed font-light tracking-wide">
                <p>
                ...
                <p className="text-white font-medium text-lg md:text-xl border-l-2 border-primary pl-4 mt-6 md:mt-8">
