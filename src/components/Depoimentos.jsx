    ...
    <section className="py-32 px-8 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-20 flex flex-col items-center text-center">
          <h2 className="text-5xl md:text-7xl text-primary mb-6 uppercase tracking-widest font-heading">O que dizem</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {testimonials.map((text, index) => (
            <div 
              key={index} 
              className={`bg-[#111111]/80 backdrop-blur-sm p-10 md:p-12 rounded-[20px] shadow-2xl border border-white/5 hover:border-primary/30 transition-all duration-300 ease-in-out transform hover:-translate-y-2 ${index % 2 !== 0 ? 'md:translate-y-12' : ''}`}
            >
